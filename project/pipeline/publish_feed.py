...
('007','When Does a Game Trace Become Evidence?','when-does-a-game-trace-become-evidence.mp3','A playful, dramatized interview with fictional research correspondent Dr. Rowan Field about learning-focused telemetry, systematic review, structural assessment, and making game-data inferences contestable.','episode-007-when-does-a-game-trace-become-evidence','episode-007')]

def atomic_copy(src, dst):
    """Copy an asset through a same-directory temporary file."""
    dst = Path(dst)
    fd, name = tempfile.mkstemp(prefix=f'.{dst.name}.', dir=str(dst.parent))
    os.close(fd)
    try:
...
def main():
    for num,title,fn,desc,guid,base in EP:
        src=ROOT/'episodes'/num/fn; dst=SITE/(base+'.mp3'); atomic_copy(src,dst); atomic_copy(ROOT/'episodes'/num/'episode-notes.md',SITE/(base+'-notes.md'))
    items=[]
    ...
    atomic_text(SITE/'feed.xml', xml)
    atomic_text(SITE/'index.html', '''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Human in the Loop</title></head><body><h1>Human in the Loop</h1><p>Private, unlisted research-review podcast feed.</p><p><a href="feed.xml">RSS feed</a> · <a href="needs-full-text.html">Full-text queue</a></p><h2>Episodes</h2><ul><li><a href="human-in-the-loop-interview.mp3">Episode 001 — When AI Joins Educational Inquiry, What Should Remain Human?</a></li><li><a href="episode-002-can-we-see-learning-in-the-game.mp3">Episode 002 — Can We See Learning in the Game?</a> · <a href="episode-002-notes.md">notes</a></li><li><a href="episode-003-when-a-game-needs-a-teacher.mp3">Episode 003 — When a Game Needs a Teacher</a> · <a href="episode-003-notes.md">notes</a></li><li><a href="episode-004-the-feeling-learner-and-the-evidence-trail.mp3">Episode 004 — The Feeling Learner and the Evidence Trail</a> · <a href="episode-004-notes.md">notes</a></li><li><a href="episode-005-what-can-a-hundred-games-teach-a-teacher.mp3">Episode 005 — What Can a Hundred Games Teach a Teacher?</a> · <a href="episode-005-notes.md">notes</a></li><li><a href="episode-006-can-play-become-evidence.mp3">Episode 006 — Can Play Become Evidence?</a> · <a href="episode-006-notes.md">notes</a></li><li><a href="episode-007-when-does-a-game-trace-become-evidence.mp3">Episode 007 — When Does a Game Trace Become Evidence?</a> · <a href="episode-007-notes.md">notes</a></li></ul></body></html>''')
